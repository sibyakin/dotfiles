...
local lsp_on_attach = function()
    ...
    vim.keymap.set('n', 'fe', '<cmd>Telescope lsp_definitions<CR>')
    vim.keymap.set('n', 'fc', '<cmd>Telescope lsp_references<CR>')
...
vim.keymap.set('n', 'fh', '<cmd>Telescope command_history<CR>')
vim.keymap.set('n', 'fb', '<cmd>Telescope buffers<CR>')
vim.keymap.set('n', 'fr', '<cmd>Telescope oldfiles<CR>')
vim.keymap.set('n', 'fff', '<cmd>Telescope find_files<CR>')
vim.keymap.set('n', 'ffb', '<cmd>Telescope file_browser<CR>')
